"""
Generation pipeline service — backwards-compatible shim.

All implementation has moved to vocabulary.services.generation/ package.
This module re-exports everything so existing imports and test patches
targeting 'vocabulary.services.generation_pipeline_service' continue to work.
"""
from vocabulary.services.generation import *  # noqa: F401, F403
...
# Re-export LLM service functions that tests patch on this module
